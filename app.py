...
DT_PATH = "Models/model_dt.pkl"
LR_PATH = "Models/model_lr.pkl"
KNN_PATH = "Models/model_knn.pkl"
...
def train_and_save_models():
    ...
    # ✅ Reduce KNN storage size by sampling training data
    KNN_SAMPLE_SIZE = 12000  # adjust if needed

    if len(x_train_scaled) > KNN_SAMPLE_SIZE:
        knn_idx = np.random.choice(len(x_train_scaled), KNN_SAMPLE_SIZE, replace=False)
    ...
    joblib.dump(models['Random Forest'], "Models/model_rf.pkl")
    joblib.dump(models['Decision Tree'], "Models/model_dt.pkl")
    joblib.dump(models['Linear Regression'], "Models/model_lr.pkl")
    joblib.dump(models['KNN'], "Models/model_knn.pkl")
...
def load_resources():
    ...
    models = {
        ...
        'Linear Regression': joblib.load(LR_PATH),
